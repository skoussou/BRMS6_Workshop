...
A simple example that calculates the average weight of the last 20 bags that entered the SORTING location could look something like this: 522 secs
...
* [A UML representation of the model](https://www.lucidchart.com/invitations/accept/1a9ac865-2b3a-45c7-8d03-15c0eb9568fe)

<div style="width: 640px; height: 480px; margin: 10px; position: relative;"><iframe allowfullscreen frameborder="0" style="width:640px; height:480px" src="https://www.lucidchart.com/documents/embeddedchart/f7216584-9731-4ddd-bd9f-3509a1d58a84" id="YFf492xoUqjR"></iframe></div>
