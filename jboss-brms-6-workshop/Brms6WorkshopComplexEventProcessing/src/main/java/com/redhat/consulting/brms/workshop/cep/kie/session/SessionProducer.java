package com.redhat.consulting.brms.workshop.cep.kie.session;
...
import org.kie.api.runtime.rule.FactHandle;//org.drools.core.FactHandle;
...
import com.redhat.consulting.brms.workshop.cep.channel.CommandDispatchChannel;
import com.redhat.consulting.brms.workshop.cep.command.SimpleCommandFactory;
import com.redhat.consulting.brms.workshop.cep.listener.HaWorkingMemoryEventListener;
...
public class SessionProducer {
	...
	private static final String SERIALIZED_KIE_SESSION_FILE_PROPERTY_NAME = "com.redhat.consulting.brms.workshop.kie.session.file";

	private static final String LOAD_KIE_SESSION_FROM_FILE_PROPERTY_NAME = "com.redhat.consulting.brms.workshop.kie.session.loadfromfile";
