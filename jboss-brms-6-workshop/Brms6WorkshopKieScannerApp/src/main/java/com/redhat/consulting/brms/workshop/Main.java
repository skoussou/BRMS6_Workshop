...
public class Main {
	...
	public static void main(String[] args) {
		...
		ReleaseId id = kieServices.newReleaseId("com.redhat.consulting.brms.workshop", "Brms6WorkshopKieScannerRules", "1.0.0-SNAPSHOT");
		...
		while (true) {
			...
			Person person = new Person("John", "Smith", new LocalDate(1979,1,30));
